...
public class UndervisningsAktivitetTest {
    ...
    public void fromJsonShouldParseAJsonObject() throws IOException {
        ...
        assertThat(ua.getUndervisning().getuSemester().getYear(), is(equalTo(INPUT_FILE_YEAR)));
        assertThat(ua.getUndervisning().getuSemester().getSemesterCode(),
            is(equalTo(INPUT_FILE_SEMESTER)));
        assertThat(ua.getUndervisning().getuSemester().getHref(),

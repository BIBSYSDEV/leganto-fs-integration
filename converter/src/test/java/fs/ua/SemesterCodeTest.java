...
public class SemesterCodeTest {
    ...
    public void semesterStartDateShouldBeTheFirstDayOfJanuaryForSpringSemester() {
        assertThat(SemesterCode.SPRING.semesterStartDate(ARBITRARY_YEAR).getDayOfMonth(),
            is(equalTo(FIRST_DAY_OF_MONTH)));
        assertThat(SemesterCode.SPRING.semesterStartDate(ARBITRARY_YEAR).getMonth(), is(equalTo(
            FIRST_MONTH_OF_SPRING_SEMESTER)));
    }

    @Test
    public void semesterStartDateShouldBeTheFirstDayOfAugustForAutumnSemester() {
        assertThat(SemesterCode.AUTUMN.semesterStartDate(ARBITRARY_YEAR).getDayOfMonth(),
            is(equalTo(FIRST_DAY_OF_MONTH)));
        assertThat(SemesterCode.AUTUMN.semesterStartDate(ARBITRARY_YEAR).getMonth(), is(equalTo(
            FIRST_MONTH_OF_AUTUM_SEMESTER)));
    }

    @Test
    public void semesterEndDateShouldBeTheLastDayOfJulyForSpringSemester() {
        assertThat(SemesterCode.SPRING.semesterEndDate(ARBITRARY_YEAR).getDayOfMonth(), is(equalTo(LAST_DAY_OF_MONTH)));
        assertThat(SemesterCode.SPRING.semesterEndDate(ARBITRARY_YEAR).getMonth(), is(equalTo(
            LAST_MONTH_OF_SPRING_SEMESTER)));
    }

    @Test
    public void semesterEndDateShouldBeTheLastDayOfJanuaryForAutumnSemester() {
        assertThat(SemesterCode.AUTUMN.semesterEndDate(ARBITRARY_YEAR).getDayOfMonth(), is(equalTo(LAST_DAY_OF_MONTH)));
        assertThat(SemesterCode.AUTUMN.semesterEndDate(ARBITRARY_YEAR).getMonth(), is(equalTo(

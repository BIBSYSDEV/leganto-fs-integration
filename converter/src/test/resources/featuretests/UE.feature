Feature:
  ...
  Background:
    ...
    And the response from /undervisning/UE_ID has a field with name "href" and value "https://fs-api/undervisning/222,emne%C3%98Kode,emneVersjon,1980,H%C3%98ST,12"
  ...
  Scenario: Update Leganto with new undervisning information
    ...
    Then the field CourseCode in the UE entry is the string "UE_222_emneØKode_emneVersjon_1980_HØST_12"
    And the field CourseTitle in the UE entry is the string "NynorskEmneNavn - emneØKode HØST 1980"
    ...
    And the field AllSearchableIds in the UE entry is the string "UE_222_emneØKode_emneVersjon_1980_HØST_12,UA_222_emneØKode_emneVersjon_1980_HØST_12,emneØKode"
  ...
  Scenario: Start date for the Spring semester for UE entries
    ...
    And the field CourseCode in the UE entry is the string "UE_222_emneØKode_emneVersjon_1980_VÅR_12"
    And the field CourseTitle in the UE entry is the string "NynorskEmneNavn - emneØKode VÅR 1980"
    And the field AllSearchableIds in the UE entry is the string "UE_222_emneØKode_emneVersjon_1980_VÅR_12,UA_222_emneØKode_emneVersjon_1980_VÅR_12,emneØKode"
  ...
  Scenario: UserInput filed operation has value ROLLOVER for UE entries
    ...
    Then the field OldCourseCode in the UE entry is the string "UE_222_emneØKode_emneVersjon_1979_HØST_12"
  ...
  Scenario: CourseTitle first alternative format
    ...
    Then the field CourseTitle in the UE entry is the string "emneØKode - NynorskEmneNavn (HØST 1980)"

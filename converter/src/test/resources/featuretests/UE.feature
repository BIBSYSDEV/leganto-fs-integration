Feature:
  ...
  Background:
    ...
    And the response from /undervisning/UE_ID has a field with name "href" and value "https://fs-api/undervisning/222,emneKode,emneVersjon,1980,H%C3%98ST,12"
  ...
  Scenario: Update Leganto with new undervisning information
    ...
    Then the field CourseCode in the UE entry is the string "UE_222_emneKode_emneVersjon_1980_HØST_12"
  ...
  Scenario: Start date for the Spring semester for UE entries
    ...
    And the field CourseCode in the UE entry is the string "UE_222_emneKode_emneVersjon_1980_VÅR_12"
  ...
  Scenario: UserInput filed operation has value ROLLOVER for UE entries
    ...
    Then the field OldCourseCode in the UE entry is the string "UE_222_emneKode_emneVersjon_1979_HØST_12"

...
#
  Scenario: Update Leganto with new undervisning information
    ...
    And the field CouseTitle in the UE entry is the string "NynorskEmneNavn - emneKode HØST 1980"
...
##    And AllInstructors is not empty
    ...
    And the field Operation in the UE entry is the the string "NORMAL"

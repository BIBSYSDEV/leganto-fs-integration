...
public class UAFeatureTest {
    ...
    public void coursecode_is_the_string_from_FS_API_undervisngsaktiviteter(String string) {
        // Write code here that turns the phrase above into concrete actions
    ...
    public void the_courses_in_FS_are_populated_in_Leganto_with_the_following_data(io.cucumber.datatable.DataTable dataTable) {
        List<String> fieldNamesCount = dataTable.asList();
        int expectedFieldsNumber = fieldNamesCount.size();
        LegantoEntry legantoEntry=new LegantoEntry();
        int actualNumberOfFields=legantoEntry.toString().split("?<=\\t").length;
